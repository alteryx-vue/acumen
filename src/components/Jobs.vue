...
<v-layout row wrap v-if="jobs.complete.length > 0">
                  ...
                  <v-container>
                    ...
                    <v-layout row>
                      ...
                      <v-flex xs2>
                        ...
                        <v-list-tile-sub-title>
                          Result code: {{ props.item.ResultCode }}
                        </v-list-tile-sub-title>
                      </v-flex>
                    </v-layout>
                </v-container>
  ...
  <v-layout row justify-center>
    <v-dialog v-model="jobResult.show" max-width="500">
      <v-card>
        <v-card-title class="headline">{{ jobResult.for }}</v-card-title>
        <v-card-text>{{ resultDetails }}</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      resultDetails(){
        return JSON.stringify(this.$store.state.jobResult.log)
      }
    },
    mounted() {
